...
while True:
    ...
    if liubang.health <= 0 and xianghu.health <= 0:
        print('xianghu 和 liubang 同时输了')
        break
...
"""
E:\Study\python\python_note\2020-03-24-Python-ZST>python 2020-03-28-03-class.py
liubang 释放第一技能： 1300
liubang 释放第二技能： 1700
xianghu 释放第一技能： 1300
xianghu 释放第二技能： 1200
