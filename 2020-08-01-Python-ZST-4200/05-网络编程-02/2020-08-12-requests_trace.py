...
if __name__ == "__main__":
    ...
    repsonse:  
      {
        ...
        "headers": {
          ...
          "Host": "httpbin.org",
          "User-Agent": "python-requests/2.24.0",   # User-Agent：用户代理；标识由哪个程序发出请求，可以理解为不同的浏览器类型
   ...
   repsonse：
      {
        ...
        "headers": {
          ...
          "Accept-Encoding": "gzip, deflate", 
          "Content-Length": "36", 
          "Content-Type": "application/x-www-form-form-data",     # 表单
          "Host": "httpbin.org", 
          "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36", 
   ...
   repsonse：
    ...
    repsonse.form = {}, response.data = "username=mysqlbin&password=guangdong"
